...
This section contains worksheet PDFs and supporting assets for a set of Scratch games. Each project has everything you need to run it as a standalone activity in a Code Club session.

<div class="scratch-project" markdown="1">

![Cat and Mouse](https://github.com/jrmhaig/Code_Club_Resources/raw/master/Scratch/CatAndMouse/CatAndMouse-banner.png){: .scratch-project-banner }
...
![Lunar Lander](https://github.com/jrmhaig/Code_Club_Resources/raw/master/Scratch/LunarLander/lander_banner_image.png){: .scratch-project-banner }
...
![Snowballs](https://github.com/jrmhaig/Code_Club_Resources/raw/master/Scratch/Snowballs/snowball-banner.png){: .scratch-project-banner }
